...
import { Search, MapPin, Star, Wifi, Car, Coffee, Waves, X, Calendar, Users } from "lucide-react"
...
const mockRooms: Room[] = [
  {
    ...
    type: "Studio",
    description: "A beautifully designed modern studio apartment in the heart of the city. Perfect for business travelers and couples looking for a comfortable stay with easy access to restaurants, shops, and public transportation.",
    maxGuests: 2,
    bedrooms: 1,
    bathrooms: 1,
  ...
  },
  {
    ...
    type: "2-Bedroom",
    description: "Spacious and cozy 2-bedroom flat located in a quiet residential neighborhood. Features a lovely balcony with garden views and is pet-friendly for those traveling with furry companions.",
    maxGuests: 4,
    bedrooms: 2,
    bathrooms: 1,
  ...
  },
  {
    ...
    type: "Penthouse",
    description: "Experience luxury living in this stunning penthouse suite. Featuring panoramic city views, premium amenities including a rooftop pool, gym access, and 24/7 concierge service.",
    maxGuests: 6,
    bedrooms: 3,
    bathrooms: 2,
  ...
  },
  {
    ...
    type: "Cottage",
    description: "A charming cottage surrounded by beautiful gardens in a peaceful suburban setting. Perfect for those seeking tranquility while still having easy access to the city center.",
    maxGuests: 3,
    bedrooms: 2,
    bathrooms: 1,
  ...
  },
  {
    ...
    type: "House",
    description: "Perfect for family getaways! This spacious home features a large backyard, fully equipped kitchen, and comfortable living spaces. Located in a safe, family-friendly neighborhood.",
    maxGuests: 8,
    bedrooms: 4,
    bathrooms: 3,
    ...
    checkInTime: "3:00 PM",
    checkOutTime: "11:00 AM",
    policies: ["Family-friendly", "No smoking", "Children welcome", "Free parking"]
  },
  {
    id: 6,
    ...
    type: "Apartment",
    description: "Wake up to stunning ocean views from this beachfront apartment. Direct beach access and a private balcony make this the perfect seaside retreat for couples and small families.",
    maxGuests: 4,
    bedrooms: 2,
    bathrooms: 2,
...
export default function HomePage() {
  ...
  const fetchAvailableRooms = async () => {
    try {
      ...
      console.log("Available rooms fetched successfully:", availableRooms)
    } catch (err) {
  ...
  const fetchRoomDetails = async (roomId: string | number) => {
    try {
      ...
      const fallbackRoom = availableRooms.find(room => room.id === roomId)
      if (fallbackRoom) {
  ...
  const handleBookNow = (roomId: string | number) => {
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 pb-0 flex justify-between items-start">
              <h2 className="text-2xl font-bold text-left pr-8">{selectedRoom.title}</h2>
              <button
                onClick={closeModal}
            ...
            <div className="p-6 pt-4">
              ...
              <div className="mb-6">
                <div className="relative rounded-lg overflow-hidden">
                  <img 
                    src={selectedRoom.image || selectedRoom.images?.[0] || "/placeholder.svg"} 
                ...
                <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">({selectedRoom.reviews} reviews)</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                    ...
                    {selectedRoom.bathrooms && (
                      <span>{selectedRoom.bathrooms} bathroom{selectedRoom.bathrooms !== 1 ? 's' : ''}</span>
                    )}
                  </div>
                  ...
                  {/* Policies */}
                  {selectedRoom.policies && selectedRoom.policies.length > 0 && (
                    <div>
                  ...
                  <div className="sticky top-4 border rounded-lg p-6 shadow-lg bg-white">
                    ...
                    {selectedRoom.hostName && (
                      <div className="mt-6 pt-6 border-t">
                        <h4 className="font-medium mb-2">Hosted by {selectedRoom.hostName}</h4>
